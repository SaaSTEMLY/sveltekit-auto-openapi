...
// This is a virtual module that gets generated by the Vite plugin
// In dev: dynamically generated with imports to actual route files
// In production: bundled with all validation schemas included
const validationRegistry: ValidationRegistry = {};

// Initialization promise for lazy-loaded modules (only in dev mode)
export const initPromise: Promise<void> | undefined = undefined;
